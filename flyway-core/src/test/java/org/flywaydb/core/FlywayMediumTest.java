...
public class FlywayMediumTest {
    ...
    public void multipleSetDataSourceCalls() throws Exception {
        DriverDataSource dataSource1 =
                new DriverDataSource(Thread.currentThread().getContextClassLoader(), (String) null, "jdbc:h2:mem:flyway_db_1;DB_CLOSE_DELAY=-1", "sa", "");

        DriverDataSource dataSource2 =
                new DriverDataSource(Thread.currentThread().getContextClassLoader(), (String) null, "jdbc:h2:mem:flyway_db_2;DB_CLOSE_DELAY=-1", "sa", "");
    ...
    public void info() throws Exception {
        DriverDataSource dataSource =
                new DriverDataSource(Thread.currentThread().getContextClassLoader(), (String) null, "jdbc:h2:mem:flyway_db_info;DB_CLOSE_DELAY=-1", "sa", null);
    ...
    public void callback() throws Exception {
        DriverDataSource dataSource =
                new DriverDataSource(Thread.currentThread().getContextClassLoader(), (String) null, "jdbc:h2:mem:flyway_db_callback;DB_CLOSE_DELAY=-1", "sa", "", "SET AUTOCOMMIT OFF");
    ...
    public void repairFirst() throws Exception {
        DriverDataSource dataSource =
                new DriverDataSource(Thread.currentThread().getContextClassLoader(), (String) null, "jdbc:h2:mem:flyway_db_repair;DB_CLOSE_DELAY=-1", "sa", "", "SET AUTOCOMMIT OFF");
    ...
    public void infoInit() throws Exception {
        DriverDataSource dataSource =
                new DriverDataSource(Thread.currentThread().getContextClassLoader(), (String) null, "jdbc:h2:mem:flyway_db_info_init;DB_CLOSE_DELAY=-1", "sa", "");
    ...
    public void initAgainWithSameVersion() throws Exception {
        DriverDataSource dataSource =
                new DriverDataSource(Thread.currentThread().getContextClassLoader(), (String) null, "jdbc:h2:mem:flyway_db_init_same;DB_CLOSE_DELAY=-1", "sa", "");
    ...
    public void initAgainWithDifferentVersion() throws Exception {
        DriverDataSource dataSource =
                new DriverDataSource(Thread.currentThread().getContextClassLoader(), (String) null, "jdbc:h2:mem:flyway_db_init_different;DB_CLOSE_DELAY=-1", "sa", "");
    ...
    public void cleanOnValidate() throws Exception {
        DriverDataSource dataSource =
                new DriverDataSource(Thread.currentThread().getContextClassLoader(), (String) null, "jdbc:h2:mem:flyway_db_clean_validate;DB_CLOSE_DELAY=-1", "sa", "");
    ...
    public void baselineAfterInit() throws Exception {
        DriverDataSource dataSource =
                new DriverDataSource(Thread.currentThread().getContextClassLoader(), (String) null, "jdbc:h2:mem:flyway_db_baseline_init;DB_CLOSE_DELAY=-1", "sa", "");
    ...
    public void baselineOnMigrate() throws Exception {
        DriverDataSource dataSource =
                new DriverDataSource(Thread.currentThread().getContextClassLoader(), (String) null, "jdbc:h2:mem:flyway_db_baseline_migrate;DB_CLOSE_DELAY=-1", "sa", "");
    ...
    public void baselineRepair() throws Exception {
        DriverDataSource dataSource =
                new DriverDataSource(Thread.currentThread().getContextClassLoader(), (String) null, "jdbc:h2:mem:flyway_db_baseline_repair;DB_CLOSE_DELAY=-1", "sa", "");
    ...
    public void baselineOnMigrateCheck() throws Exception {
        DriverDataSource dataSource =
                new DriverDataSource(Thread.currentThread().getContextClassLoader(), (String) null, "jdbc:h2:mem:flyway_db_baseline_migrate_check;DB_CLOSE_DELAY=-1", "sa", "");
    ...
    public void baselineOnMigrateSkipFailed() throws Exception {
        DriverDataSource dataSource =
                new DriverDataSource(Thread.currentThread().getContextClassLoader(), (String) null, "jdbc:h2:mem:flyway_db_baseline_migrate_failed;DB_CLOSE_DELAY=-1", "sa", "");
    ...
    public void cleanUnknownSchema() throws Exception {
        DriverDataSource dataSource =
                new DriverDataSource(Thread.currentThread().getContextClassLoader(), (String) null, "jdbc:h2:mem:flyway_db_clean_unknown;DB_CLOSE_DELAY=-1", "sa", "");
    ...
    public void outOfOrder() {
        DriverDataSource dataSource =
                new DriverDataSource(Thread.currentThread().getContextClassLoader(), (String) null, "jdbc:h2:mem:flyway_out_of_order;DB_CLOSE_DELAY=-1", "sa", "");
    ...
    private static class OpenConnectionCountDriverDataSource extends DriverDataSource {
        ...
        public OpenConnectionCountDriverDataSource() {
            super(Thread.currentThread().getContextClassLoader(), (String) null, "jdbc:h2:mem:flyway_db_open_connection;DB_CLOSE_DELAY=-1", "sa", "");
        }
