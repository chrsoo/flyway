...
public class DerbyMigrationMediumTest extends MigrationTestCase {
    ...
    public void tearDown() throws Exception {
        try {
            new DriverDataSource(Thread.currentThread().getContextClassLoader(), (String) null, "jdbc:derby:memory:flyway_db;drop=true", "", "").getConnection();
    ...
    protected DataSource createDataSource(Properties customProperties) {
        return new DriverDataSource(Thread.currentThread().getContextClassLoader(), (String) null, "jdbc:derby:memory:flyway_db;create=true", "", "");
    }
