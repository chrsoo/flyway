...
public class H2ConcurrentMigrationMediumTest extends ConcurrentMigrationTestCase {
    ...
    protected DataSource createDataSource(Properties customProperties) {
        return new DriverDataSource(Thread.currentThread().getContextClassLoader(), (String) null, "jdbc:h2:mem:flyway_db_concurrent;DB_CLOSE_DELAY=-1", "sa", "", "SET LOCK_TIMEOUT 100000");
    }
}