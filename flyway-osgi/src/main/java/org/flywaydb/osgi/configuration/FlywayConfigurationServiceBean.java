 ...
 */
package org.flywaydb.osgi.configuration;
...
/**
 * Manages Flyway configurations for the Managed Service Factory PID
 * {@value #FLYWAY_FACTORY_PID}.
 */
public class FlywayConfigurationServiceBean
		implements ManagedServiceFactory, FlywayConfigurationService {

	private static final Log LOG = LogFactory.getLog(FlywayConfigurationServiceBean.class);

	public static final String FLYWAY_FACTORY_PID = "org.flywaydb.osgi";
	...
	public FlywayConfigurationServiceBean(BundleContext context) {
